...
- ปรับช่วงปีย้อนหลัง 5 / 10 / 20 ปี คำนวณฝั่ง browser จาก `draws.json`
- ช่องค้นเลข พิมพ์ 2 หลักแล้วเลื่อนไปหา + ไฮไลต์แถวนั้น
- แตะเลขดูวันที่ออกแต่ละครั้ง ในช่วงปีที่เลือก
- Chip "ออกบ่อยสุด" / "ไม่เคยออกเลย" ปรับตามช่วงปีที่เลือกอัตโนมัติ
- ติดตั้งขึ้นหน้าจอมือถือได้ (manifest + icon 3 ขนาด + apple-touch-icon)
